  ...
  return (
    <div className="border rounded bg-dark text-light mb-3">
      <div className="d-flex justify-content-between align-items-center p-2 bg-secondary">
        ...
        <button className="btn btn-sm btn-outline-light" onClick={handleCopy}>Copy code</button>
      </div>
      <SyntaxHighlighter language={language} style={oneDark} customStyle={{ padding: '1rem' }}>
        {children}
      </SyntaxHighlighter>
    </div>
  );
